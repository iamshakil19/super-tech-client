...
import { forGarmentsFilterData } from "../../../Utils/LocalData";
import { useState } from "react";
import { useDispatch } from "react-redux";
import { useEffect } from "react";
import { handleGarmentsCollectionPageCategoryFilter } from "../../../features/products/productsSlice";
...
const ForGarments = () => {
  ...
  useEffect(() => {
    ...
    dispatch(handleGarmentsCollectionPageCategoryFilter(categoryFilterString));
  }, [subCategoryFilter, dispatch]);
  return (
    <div>
      {forGarmentsFilterData.map((data) => (
        <div
          key={data.value}
