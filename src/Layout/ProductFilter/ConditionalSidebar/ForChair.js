...
import { forChairFilterData } from "../../../Utils/LocalData";
import { useState } from "react";
import { useDispatch } from "react-redux";
import { useEffect } from "react";
import { handleChairCollectionPageCategoryFilter } from "../../../features/products/productsSlice";
...
const ForChair = () => {
  ...
  useEffect(() => {
    ...
    dispatch(handleChairCollectionPageCategoryFilter(categoryFilterString));
  }, [subCategoryFilter, dispatch]);
  return (
    <div>
      {forChairFilterData.map((data) => (
        <div
          key={data.value}
