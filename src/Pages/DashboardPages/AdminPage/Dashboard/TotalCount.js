  ...
  return (
    <div className="poppins my-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-5">
      <div className="flex items-center gap-5 bg-white p-3 py-5 rounded-md shadow-lg shadow-gray-200 border border-gray-200">
        ...
        <div>
          <h2 className="text-lg font-bold text-slate-500">Total Sales</h2>
      ...
      <div className="flex items-center gap-5 bg-white p-3 py-5 rounded-md shadow-lg shadow-gray-200 border border-gray-200">
        ...
        <div>
          <h2 className="text-lg font-bold text-slate-500">Total Orders</h2>
          {orderLoading && <p>Loading...</p>}
      ...
      <div className="flex items-center gap-5 bg-white p-3 py-5 rounded-md shadow-lg shadow-gray-200 border border-gray-200">
        ...
        <div>
          <h2 className="text-lg font-bold text-slate-500">Total Products</h2>
      ...
      <div className="flex items-center gap-5 bg-white p-3 py-5 rounded-md shadow-lg shadow-gray-200 border border-gray-200">
        ...
        <div>
          <h2 className="text-lg font-bold text-slate-500">Total Users</h2>
      ...
      <div className="flex items-center gap-5 bg-white p-3 py-5 rounded-md shadow-lg shadow-gray-200 border border-gray-200">
        ...
        <div>
          <h2 className="text-lg font-bold text-slate-500">Completed Order</h2>
          {orderLoading && <p>Loading...</p>}
          {!isOrderError && !orderLoading && (
            <p className="flex items-center font-semibold ">
      ...
      <div className="flex items-center gap-5 bg-white p-3 py-5 rounded-md shadow-lg shadow-gray-200 border border-gray-200">
        ...
        <div>
          <h2 className="text-lg font-bold text-slate-500">Pending Order</h2>
          {orderLoading && <p>Loading...</p>}
          {!isOrderError && !orderLoading && (
            <p className="flex items-center font-semibold ">
              {pendingOrder?.length}
      ...
      <div className="flex items-center gap-5 bg-white p-3 py-5 rounded-md shadow-lg shadow-gray-200 border border-gray-200">
        ...
        <div>
          <h2 className="text-lg font-bold text-slate-500">Cancel Order</h2>
          {orderLoading && <p>Loading...</p>}
          {!isOrderError && !orderLoading && (
            <p className="flex items-center font-semibold ">
              {cancelOrder?.length}
