  ...
  return (
    <div className="poppins my-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-5">
      <div className="flex items-center justify-center gap-5 bg-white p-3 py-5 rounded-md shadow-lg shadow-gray-300">
        ...
        <div>
          <h2 className="text-lg font-bold text-slate-400 whitespace-nowrap">Total Sales</h2>
          <p className="flex items-center font-semibold ">
            {" "}
            <TbCurrencyTaka size={23} className="mb-1" />
            4455455{" "}
          </p>
        </div>
      </div>
      <div className="flex items-center justify-center gap-5 bg-white p-3 py-5 rounded-md shadow-lg shadow-gray-300">
        ...
        <div>
          <h2 className="text-lg font-bold text-slate-400 whitespace-nowrap">Total Orders</h2>
      ...
      <div className="flex items-center justify-center gap-5 bg-white p-3 py-5 rounded-md shadow-lg shadow-gray-300">
        ...
        <div>
          <h2 className="text-lg font-bold text-slate-400 whitespace-nowrap">Total Products</h2>
      ...
      <div className="flex items-center justify-center gap-5 bg-white p-3 py-5 rounded-md shadow-lg shadow-gray-300">
        ...
        <div>
          <h2 className="text-lg font-bold text-slate-400 whitespace-nowrap">Total Users</h2>
