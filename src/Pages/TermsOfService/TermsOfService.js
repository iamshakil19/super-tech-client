  ...
  return (
    <div className="poppins my-10 px-5">
      ...
      <div className="max-w-3xl mx-auto text-black">
        ...
        <p className="text-lg font-bold font-serif mt-5">OVERVIEW</p>
        <p className="mt-4 text-justify">
          This website is operated by super tech Furniture. Throughout the site,
          the terms “we”, “us” and “our” refer to super tech Furniture. super
          tech Furniture offers this website, including all information, tools
        ...
        <p className="text-lg font-bold font-serif my-5">
        ...
        <p className="mt-4 text-justify">
          ...
          non-infringement. In no case shall super tech Furniture, our
        ...
        <p className="mt-4 text-justify">
          You agree to indemnify, defend and hold harmless super tech Furniture
